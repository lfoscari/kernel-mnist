...
def matrix(x_train, tuning_degree):
	...
	print(f"Computing kernel matrix with degree {tuning_degree}...")
...
def train(x_train, y_train, approach, tuning_epochs, tuning_degree, model_location):
...
def main():
	...
	for approach in ["min", "mean", "last", "weight"]:
		epochs = results[SIZE][approach]["epochs"]
		degree = results[SIZE][approach]["degree"]
		...
		if degree != last_degree:
			...
			print("Kernel degree is unchanged")
